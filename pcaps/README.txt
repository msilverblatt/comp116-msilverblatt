...
When using FTP all data in packets is sent in a plain-text format, meaning it is visible to anyone who can intercept the packet.

4. What is the secure alternative to the protocol used to transfer files?
SFTP is a secure version of the file transfer protocol that encrypts all data being sent over a network
...
I managed to find 9 username-password pairs.

12. Briefly describe how you found the username-password pairs.
A combination of using tcpreplay to pip the pcap files into dsniff and using wireshark's search for packet by string functionality to find login credentials

13. For each of the plaintext username-password pair that you found, identify the protocol used, server IP, the corresponding domain name (e.g., google.com), and port number.

10.117.15.217 from 67.128.149.178
mbergeson@hjnews.com
mb123on
Ok logged in
POP Port 110

62.173.185.22 from 10.124.15.238
brewer
1qazxsw209simona12
Ok logged in
POP Port 110

144.122.144.179 (imap.metu.edu.tr) from 10.122.15.146
e129286
4.Ekkama
FAILED
POP Port 110
...
109.168.119.166 from 10.124.15.238
dmartini@cutaway.it
se1lasa
Login OK
IMAP Port 143
...
None of the telnet pairs received a successful response. The two POP pairs and the IMAP pairs appeared to log in successfully. 

15. How did you verified the successful username-password pairs?
I could not verify whether they are still valid today without logging in, but the successful login attempts received confirmations within the same stream.
...
In short, it is illegal and immoral. 
...
Only enter sensitive information on sites that use https for authentication!
...
I used Wireshark to obtain the following information, using the show address resolution tool in the statistics menu.

# Hosts information in Wireshark 
#
# Host data gathered from /Users/dafox420/Downloads/set2.pcap
...
TCP, UDP, SSL, Data, HTTP, Telnet, FTP, FTP-data, SSH, IMAP, XMPP, ESP, ISKAKMP, DNS, ICMP, ARP, POP, SIP, Bootstrap, NetBIOS Name Service, OpenVPN, Network Time.

I used the wireshark->statistics->protocol hierarchy funtion to find this informatiom. FTP-data was the most popular protocol by % of packets, followed by HTTP, Data, and SSL.

20. A fun question: what other interesting things did you find in this PCAP set (e.g., files)?

pdfs about computer security, someone syncing their dropbox, a youtube video, also a UDP authentication request with a username but no password